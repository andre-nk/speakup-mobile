...
mixin _$ArticleState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<Article> recommendations) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<Article> recommendations)? loaded,
...
abstract class _$$LoadedImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Article> recommendations});
}
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(final List<Article> recommendations)
    : _recommendations = recommendations;

  final List<Article> _recommendations;
  @override
  List<Article> get recommendations {
  ...
  @override
  String toString() {
    return 'ArticleState.loaded(recommendations: $recommendations)';
  }
...
abstract class _Loaded implements ArticleState {
  const factory _Loaded(final List<Article> recommendations) = _$LoadedImpl;
